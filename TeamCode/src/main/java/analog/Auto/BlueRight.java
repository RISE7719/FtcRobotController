...
public class BlueRight extends LinearOpMode {
    ...
    private void movementSet1() {
        ...
        encoderDrive(DRIVE_SPEED,  -390,  -390, -390, -390, 2.0);
        encoderDrive(STRAFE_SPEED,  -90,  90, 90, -90, 2.5);
        encoderDrive(DRIVE_SLOW_SPEED,  -85,  -85, -85, -85, 1.5);
    ...
    private void movementSet2() {
        ...
        encoderDrive(DRIVE_SPEED,  -360,  -360, -360, -360, 2.0);
        encoderDrive(STRAFE_SPEED,  20,  -20, -20, 20, 0.8);
        encoderDrive(STRAFE_SPEED,  -122,  122, 122, -122, 3.0);
        encoderDrive(DRIVE_SLOW_SPEED,  -100,  -100, -100, -100, 2.0);
    ...
    private void movementSet3() {
        ...
        encoderDrive(STRAFE_SPEED,  -175,  175, 175, -175, 3.0);
