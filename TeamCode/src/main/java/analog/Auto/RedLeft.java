...
public class RedLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Wrist = hardwareMap.get(Servo.class, "Wrist");
         PW = hardwareMap.servo.get("PullUpServo");
    ...
    private void movementSet3() {
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  13,  13, 13, 13, 4.0);
       ...
       /* encoderDrive(STRAFE_SPEED,  140,  -140, -140, 140, 4.0);
        encoderDrive(TURN_SPEED,   -225, 225, -225, 225, 4.0);
        encoderDrive(DRIVE_SPEED,  -360,  -360, -360, -360, 1.0);
        sleep(100);
        encoderDrive(STRAFE_SPEED,  -30,  30, 30, -30, 1.0);
        encoderDrive(STRAFE_SPEED,  100,  -100, -100, 100, 3.0);
        encoderDrive(DRIVE_SLOW_SPEED,  -90,  -90, -90, -90, 1.0);
...
*/
    ...
    private void movementSet2() {
      ...
      /*  encoderDrive(DRIVE_SLOW_SPEED,  -117,  -117, -117, -117, 3.5);
        encoderDrive(TURN_SPEED,   -115, 115, -115, 115, 4.0);
        encoderDrive(DRIVE_SPEED,  -370,  -370, -370, -370, 3.5);
        encoderDrive(STRAFE_SPEED,  -20,  20, 20, -20, 1.0);
        encoderDrive(STRAFE_SPEED,  135,  -135, -135, 135, 3.0);
        encoderDrive(DRIVE_SLOW_SPEED,  -95,  -95, -95, -95, 1.8);
        //encoderDrive(DRIVE_SLOW_SPEED,  7,  7, 7, 7, 0.5);
  ...
  */  }
    ...
    private void movementSet1() {
        ...
        encoderDrive(STRAFE_SPEED,  -170,  170, 170, -170, 3.0);
        encoderDrive(TURN_SPEED,   -225, 225, -225, 225, 4.0);
        encoderDrive(DRIVE_SLOW_SPEED,  -10,  -10, -10, -10, 1.0);
        sleep(150);
        Conveyor.setPower(1);
        sleep(800);
        Conveyor.setPower(0);
        ...
        encoderDrive(STRAFE_SPEED,  -20,  20, 20, -20, 1.0);
        encoderDrive(STRAFE_SPEED,  170,  -170, -170, 170, 3.0);
        encoderDrive(DRIVE_SLOW_SPEED,  -65,  -65, -65, -65, 1.5);
