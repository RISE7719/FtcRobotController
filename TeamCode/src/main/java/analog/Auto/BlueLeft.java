...
public class BlueLeft extends LinearOpMode {
    ...
    private void movementSet3() {
        ...
        encoderDrive(STRAFE_SPEED,  -140,  140, 140, -140, 5.0);
        encoderDrive(DRIVE_SLOW_SPEED,  35,  35, 35, 35, 5.0);
    ...
    private void movementSet2() {
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  -45,  -45, -45, -45, 5.0);
        ...
        encoderDrive(STRAFE_SPEED,  55,  -55, -55, 55, 5.0);
    ...
    private void movementSet1() {
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  55,  55, 55, 55, 5.0);
        encoderDrive(STRAFE_SPEED,  -40,  40, 40, -40, 5.0);
        sleep(200);
        Conveyor.setPower(1);
        sleep(800);
        Conveyor.setPower(0);
        sleep(500);
        encoderDrive(STRAFE_SPEED,  -125,  125, 125, -125, 5.0);
        encoderDrive(TURN_SPEED,   110, -110, 110, -110, 4.0);
        encoderDrive(STRAFE_SPEED,  -15,15, 15, -15,4.0);
