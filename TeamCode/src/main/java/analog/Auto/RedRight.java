...
public class RedRight extends LinearOpMode {
    ...
    private void movementSet1() {
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  20,  20, 20, 20, 5.0);
        encoderDrive(STRAFE_SPEED,  -155,  155, 155, -155, 5.0);
        encoderDrive(TURN_SPEED,   215, -215, 215, -215, 5.0);
        encoderDrive(DRIVE_SLOW_SPEED,  13,  13, 13, 13, 5.0);
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  -210,  -210, -210, -210, 5.0);
        ...
        Lift.setPower(0);
        encoderDrive(STRAFE_SPEED, 50, -50, -50, 50, 4.0);
    ...
    private void movementSet2() {
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  70,  70, 70, 70, 5.0);
        encoderDrive(STRAFE_SPEED,  -200,  200, 200, -200, 5.0);
        encoderDrive(TURN_SPEED,   215, -215, 215, -215, 5.0);
        ...
        encoderDrive(DRIVE_SLOW_SPEED,  -120,  -120, -120, -120, 5.0);
        encoderDrive(STRAFE_SPEED,  -45,  45, 45, -45, 5.0);
    ...
    private void movementSet3() {
        ...
        encoderDrive(STRAFE_SPEED,  -15,  15, 15, -15, 5.0);
        encoderDrive(TURN_SPEED,   -115, 115, -115, 115, 5.0);
        encoderDrive(DRIVE_SLOW_SPEED,  50,  50, 50, 50, 5.0);
        encoderDrive(STRAFE_SPEED,  65,  -65, -65, 65, 5.0);
        ...
        encoderDrive(STRAFE_SPEED,  130,  -130, -130, 130, 5.0);
        encoderDrive(TURN_SPEED,   -110, 110, -110, 110, 4.0);
        encoderDrive(DRIVE_SLOW_SPEED,  -22,  -22, -22, -22, 5.0);
        encoderDrive(STRAFE_SPEED,  10,-10, -10, 10,4.0);
        ...
        encoderDrive(DRIVE_SPEED,  10,  10, 10, 10, 3.0);
        Lift.setPower(0);
        encoderDrive(STRAFE_SPEED, 120, -120, -120, 120, 4.0);
        sleep(1000);    }
    ...
    private void initTfod() {
        ...
        myTfodProcessorBuilder.setModelFileName("red among us");
        // Set the full ordered list of labels the model is trained to recognize.
        myTfodProcessorBuilder.setModelLabels(JavaUtil.createListWith("model_2024 0123_135802.tflite", null));
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            //newtarget1 = fl + (newTarget -  fl) * 0.2;
            //double newspeed = 0.2;
